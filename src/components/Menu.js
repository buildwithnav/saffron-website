    ...
    subcategories: [
      ...
      },
      {
        ...
        items: [
          ...
          { name: 'Lamb Seekh Kebab', price: null, description: 'Small $85 / Large $160', tags: [] },
          { name: 'Lamb Tikka', price: null, description: 'Small $85 / Large $160', tags: [] },
      ...
      },
      {
        ...
        items: [
          ...
          { name: 'Gobhi Manchurian', price: null, description: 'Small $65 / Large $120', tags: ['V'] },
          ...
          { name: 'Chilli Chicken', price: null, description: 'Small $75 / Large $140', tags: ['S'] },
        ],
      },
      {
        title: 'Vegetable Entrées',
        items: [
          { name: 'Mixed Vegetable', price: null, description: 'Small $70 / Large $130', tags: ['V'] },
          { name: 'Aloo Matar', price: null, description: 'Small $70 / Large $130', tags: ['V'] },
          { name: 'Mushroom Matar', price: null, description: 'Small $70 / Large $130', tags: ['V'] },
          { name: 'Navratan Korma', price: null, description: 'Small $70 / Large $130', tags: ['V'] },
          { name: 'Aloo Gobhi', price: null, description: 'Small $70 / Large $130', tags: ['V'] },
          { name: 'Malai Kofta', price: null, description: 'Small $70 / Large $130', tags: ['V'] },
          { name: 'Baigan Bhartha', price: null, description: 'Small $70 / Large $130', tags: ['V'] },
          { name: 'Bhindi Masala', price: null, description: 'Small $70 / Large $130', tags: ['V'] },
          { name: 'Aloo Saag', price: null, description: 'Small $70 / Large $130', tags: ['V'] },
          { name: 'Methi Malai Matar', price: null, description: 'Small $70 / Large $130', tags: ['V'] },
        ],
      },
      {
      ...
      },
      {
        title: 'Dal',
        items: [
          { name: 'Chana Masala', price: null, description: 'Small $55 / Large $100', tags: ['V'] },
          { name: 'Dal Makhani', price: null, description: 'Small $55 / Large $100', tags: ['V'] },
          { name: 'Dal Tadka', price: null, description: 'Small $55 / Large $100', tags: ['V'] },
        ],
      },
      {
