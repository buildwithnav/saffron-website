  ...
  'Party Trays': {
    subcategories: [
      ...
      },
      {
        title: 'Salads',
        items: [
          { name: 'Caesar Salad', price: null, description: 'Small $25 / Large $45', tags: ['V'] },
          { name: 'Indian Garden Salad', price: null, description: 'Small $25 / Large $45', tags: ['V'] },
        ],
      },
      {
        title: 'Tandoori Grill',
        items: [
          { name: 'Chicken Tikka', price: null, description: 'Small $75 / Large $140', tags: [] },
          { name: 'Chicken Tandoori', price: null, description: 'Small $65 / Large $120', tags: [] },
          { name: 'Chicken Malai Tikka', price: null, description: 'Small $75 / Large $140', tags: [] },
      ...
      },
      {
        ...
        items: [
          ...
          { name: 'Hakka Noodles with Chicken', price: null, description: 'Small $75 / Large $140', tags: [] },
          { name: 'Veg Fried Rice', price: null, description: 'Small $50 / Large $90', tags: ['V'] },
          { name: 'Fried Rice with Chicken', price: null, description: 'Small $60 / Large $110', tags: [] },
          { name: 'Chilli Chicken', price: null, description: 'Small $65 / Large $120', tags: ['S'] },
        ],
      },
      {
        title: 'Vegetable Entrées',
        items: [
          { name: 'Mixed Vegetable', price: null, description: 'Small $65 / Large $120', tags: ['V'] },
          { name: 'Aloo Matar', price: null, description: 'Small $65 / Large $120', tags: ['V'] },
          { name: 'Mushroom Matar', price: null, description: 'Small $65 / Large $120', tags: ['V'] },
          { name: 'Navratan Korma', price: null, description: 'Small $65 / Large $120', tags: ['V'] },
          { name: 'Aloo Gobhi', price: null, description: 'Small $65 / Large $120', tags: ['V'] },
          { name: 'Malai Kofta', price: null, description: 'Small $65 / Large $120', tags: ['V'] },
          { name: 'Baigan Bhartha', price: null, description: 'Small $65 / Large $120', tags: ['V'] },
          { name: 'Bhindi Masala', price: null, description: 'Small $65 / Large $120', tags: ['V'] },
          { name: 'Aloo Saag', price: null, description: 'Small $65 / Large $120', tags: ['V'] },
          { name: 'Methi Malai Matar', price: null, description: 'Small $65 / Large $120', tags: ['V'] },
      ...
      },
      {
        title: 'Dal',
        items: [
          { name: 'Chana Masala', price: null, description: 'Small $50 / Large $90', tags: ['V'] },
          { name: 'Dal Makhani', price: null, description: 'Small $50 / Large $90', tags: ['V'] },
          { name: 'Dal Tadka', price: null, description: 'Small $50 / Large $90', tags: ['V'] },
        ],
      },
      {
        ...
        items: [
          ...
          { name: 'Mango Chicken', price: null, description: 'Small $75 / Large $140', tags: [] },
          { name: 'Chicken Vindaloo', price: null, description: 'Small $75 / Large $140', tags: ['S'] },
          { name: 'Chicken Saag', price: null, description: 'Small $75 / Large $140', tags: [] },
        ],
      },
      {
        title: 'Lamb Entrées',
        items: [
          { name: 'Lamb Rogan Josh', price: null, description: 'Small $95 / Large $180', tags: ['S'] },
          { name: 'Lamb Bhuna', price: null, description: 'Small $95 / Large $180', tags: [] },
          { name: 'Lamb Tikka Masala', price: null, description: 'Small $95 / Large $180', tags: [] },
          { name: 'Lamb Korma', price: null, description: 'Small $95 / Large $180', tags: [] },
          { name: 'Lamb Curry', price: null, description: 'Small $80 / Large $150', tags: [] },
          { name: 'Karahi Lamb', price: null, description: 'Small $95 / Large $180', tags: [] },
          { name: 'Lamb Vindaloo', price: null, description: 'Small $95 / Large $180', tags: ['S'] },
          { name: 'Lamb Saag', price: null, description: 'Small $95 / Large $180', tags: [] },
        ],
      },
      {
        title: 'Goat Entrées',
        items: [
          { name: 'Goat Curry', price: null, description: 'Small $95 / Large $180', tags: [] },
          { name: 'Goat Bhuna', price: null, description: 'Small $105 / Large $195', tags: [] },
        ],
      },
      {
        title: 'Seafood Entrées',
        items: [
          { name: 'Shrimp Tikka Masala', price: null, description: 'Small $105 / Large $195', tags: [] },
          { name: 'Shrimp Coconut Curry', price: null, description: 'Small $105 / Large $195', tags: [] },
          { name: 'Shrimp Curry', price: null, description: 'Small $105 / Large $195', tags: [] },
          { name: 'Fish Curry', price: null, description: 'Small $105 / Large $195', tags: [] },
        ],
      },
      {
        title: 'Rice & Biryani',
        items: [
          ...
          { name: 'Lamb Biryani', price: null, description: 'Small $75 / Large $140', tags: [] },
          { name: 'Goat Biryani', price: null, description: 'Small $80 / Large $150', tags: [] },
